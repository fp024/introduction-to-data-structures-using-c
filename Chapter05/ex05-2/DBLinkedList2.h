 ...
 * 문제 05-2 헤더
 */
#ifndef __DB_LINKED_LIST_2_H__
#define __DB_LINKED_LIST_2_H__
...
typedef struct _DLinkedList {
    Node* head;     // 머리를 가리키는 멤버
    Node* tail;     // 꼬리를 가리키는 멤버
    Node* cur;      // 참조 및 삭제를 돕는 맴버 - 현재 리스트가 가리키고 있는 맴버
